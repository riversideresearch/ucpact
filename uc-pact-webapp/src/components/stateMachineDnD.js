...
function StateMachineDnD(props) {
    ...
    const saveComponentInfo = (e) => {
        ...
        thisStateMachineSelector.transitions.forEach((transition, idx) => {
            ...
            if (subFuncMessages.find(element => element.id === transitionOutMessageRefArray[idx].current.value)) {
                thisOutMessage = subFuncMessages.find(element => element.id === transitionOutMessageRefArray[idx].current.value);
            } else if (paramInterMessages.find(element => element.id === transitionOutMessageRefArray[idx].current.value)) {
                thisOutMessage = paramInterMessages.find(element => element.id === transitionOutMessageRefArray[idx].current.value)
            } else {
                thisOutMessage = interSelector.messages.find(element => element.id === transitionOutMessageRefArray[idx].current.value);
            }
    ...
    const handleSelectChange = () => {
        thisStateMachineSelector.transitions.forEach((transition, idx) => {
            ...
            dispatch(changeTransitionDispatch(newTransition));
